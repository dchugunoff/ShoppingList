...
import com.chugunov.shoppinglist.presentation.ShopApplication
...
class ShopListProvider : ContentProvider() {
    ...
    private val uriMatcher = UriMatcher(UriMatcher.NO_MATCH).apply {
        addURI("com.chugunov.shoppinglist", "shop_items", GET_SHOP_ITEM_QUERY)
        addURI("com.chugunov.shoppinglist", "shop_items/#", GET_SHOP_ITEM_BY_ID_QUERY)
    }
